...
if(Singular_FOUND)
  ...
  target_include_directories(Singular SYSTEM INTERFACE
    "${SINGULAR_INCLUDE_DIR}"
    "${SINGULAR_INCLUDE_DIR}/singular"
    "${GMP_INCLUDE_DIR}"
    "${FLINT_HOME}/include"
  )
  target_link_libraries(Singular INTERFACE
    ${SINGULAR_LIBRARY}
    ${FLINT_LIBRARY} 
    ${OMALLOC_LIBRARY}
    ${POLYS_LIBRARY}
  ...
  # Set Singular variables for use in other CMake files
  set(Singular_LIBRARIES Singular)
