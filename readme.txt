...
This table summarizes computation times for different graph sectors using **FLINT C++**, comparing **sequential**, **local**, and **parallel** strategies.

| Sector     | Singular Time (s) | Singular + FLINT Time (s) |
|------------|-------------------|----------------------------|
| {1,2,3}    | 2                 | 0.22                       |
| {1,2}      | 85                | 0.78                       |
| {2,3}      | 126               | 0.91                       |
