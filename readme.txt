...
```
# gpi-space/bin/gspc-logging-to-stdout.exe --port 9876
#  ps aux | grep gspc-logging-to-stdout
This will provide the missing libicui18n.so.67 and related libraries.
